					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
						...
						<tr>
							<td align="center" valign="top">
								<form action="<%=request.getContextPath() %>/manage/grade.do?method=query" method="post">
								<table width="96%" height="40" border="0" cellpadding="0" cellspacing="0">
									<tr>
									<%
									String zhonglei = (String)request.getAttribute("zhonglei");
									%>
										<td align="left" valign="middle">&nbsp;
											查询条件： 
											<select name="zhonglei">
												<option value="examinee_id" <%="examinee_id".equals(zhonglei)?"selected":"" %>>准考证号</option>
												<option value="course_name" <%="course_name".equals(zhonglei)?"selected":"" %>>考试课程</option>
												<option value="grade_minute_use" <%="grade_minute_use".equals(zhonglei)?"selected":"" %>>考试时间</option>
											</select>
											&nbsp;关键字： 
											<%
