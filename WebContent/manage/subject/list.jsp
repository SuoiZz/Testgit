					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
						...
						<tr>
							<td align="center" valign="top">
								<form action="<%=request.getContextPath() %>/manage/subject.do?method=query" method="post">
									...
									<tr>
										<td align="left" valign="middle">&nbsp;
											...
											<%String zhonglei = (String)request.getAttribute("zhonglei");%>
												...
												<option value="course_id" <%="course_id".equals(zhonglei)?"selected":"" %>>课程名称</option>
												<option value="subject_name" <%="subject_name".equals(zhonglei)?"selected":"" %>>试题名称</option>
											</select>
											&nbsp;关键字： 
