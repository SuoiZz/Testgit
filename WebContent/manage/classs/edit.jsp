									...
									<table width="96%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
										<tr align="center">
								    		...
								    		<td align="left">
								      			...
								      			<input type = "hidden" name = "classs_id" value="<%=map.get("classs_id") %>"/>
								    	...
								    	<tr>
								      		...
								      		<td align="left">
												...
												&nbsp;
												<input type="button" name="button" value=" 返回 " onclick="window.location.href='<%=request.getContextPath() %>/manage/classs.do?method=query'" class="btn_grey">		
											</td>
								    	</tr>
									</table>
								</form>
