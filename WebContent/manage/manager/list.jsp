									...
									<tr>
										...
										<td align="right">
											...
											当前管理员：<%=((Map)session.getAttribute("user")).get("manager_name")%>&nbsp;
										        当前的在线人数为:<font color="red"><%=application.getAttribute("numsessions")%>人</font>
										    取出通过ServletContextListener预先加载的password:  <%=((Map)application.getAttribute("map_mylisternter")).get("password")%>
										</td>
									</tr>
								</table></td>
						</tr>
								...
								<table width="96%" height="40" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td  height="30" align="right">
											...
											<a href="<%=request.getContextPath()%>/manage/manager.do?method=addPage">添加管理员信息</a>&nbsp;&nbsp;
										</td>
									</tr>
								</table>
								 <table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
									<tr align="center" bgcolor="#A8D8FC">
										...
										<td width="20%" height="26" bgcolor="#B2D6F1">管理员名称</td>
										<td width="40%" height="26" bgcolor="#B2D6F1">管理员头像</td>
										<td width="20%" height="26" bgcolor="#B2D6F1">修改</td>
										<td width="10%" height="26" bgcolor="#B2D6F1">删除</td>
									</tr>
                                    <%
									...
									<tr>
									    ...
									    <td style="padding:5px;"><%=map.get("manager_name")%></td>
									     <td style="padding:5px;"><img  style="width:50px;height:50px" src="<%=request.getContextPath()%>/manage/manager.do?method=download&manager_imgpath=<%=map.get("manager_imgpath")%>"/></td>
										<td>&nbsp;
                                   ...
                                   <!--  <tr><td>本次创建的sessionId=<%=session.getAttribute("sessionId")%></td></tr>-->
								</table>
							</td>
						</tr>
					</table></td>
